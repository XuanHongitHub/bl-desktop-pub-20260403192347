...
export function LinearHeader() {
  return (
    <header
      className="sticky top-0 z-50 border-b border-border/60 bg-background/88 backdrop-blur-2xl"
      data-transparent-header="false"
    >
      <nav aria-label="Main" className="mx-auto w-full max-w-[1120px] px-6">
        <div className="flex h-16 items-center">
          <ul
            aria-label="Site navigation"
            className="flex w-full items-center gap-6 text-[13px] font-medium"
          >
            <li className="mr-4 flex shrink-0 items-center">
              <Link
                href="/"
            ...
            {navItems.map((item) => (
              <li key={item.href} className="hidden text-muted-foreground lg:block">
                <Link
                  href={item.href}
            ...
            <li className="hidden lg:block">
              <Link
                href="/auth"
                className="inline-flex h-8 items-center rounded-md border border-border bg-card px-3 text-[13px] font-semibold text-foreground transition-colors hover:bg-muted"
              >
                Sign up
              </Link>
            </li>
