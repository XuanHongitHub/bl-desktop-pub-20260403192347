...
!function (t, e) {
  ...
  var dn = "[object z]" === String(ln),
    ...
    yn = xt("iterator"),
    mn = function mn(t) {
      if (!U(t)) return pt(t, yn) || pt(t, "@@iterator") || un[gn(t)];
    },
    bn = TypeError,
    ...
    xn = function xn(t, e) {
      var n,
        ...
        o,
        i = X(Rn, this);
      we ? n = we(Pn(), i ? ye(this) : Rn) : (n = i ? this : $e(Rn), ce(n, Tn, "Error")), void 0 !== e && ce(n, "message", function (t, e) {
  ...
  var Un,
    ...
    Xn = xt("iterator"),
    $n = !1;
  [].keys && ("next" in (Gn = [].keys()) ? (qn = ye(ye(Gn))) !== Object.prototype && (Un = qn) : $n = !0);
  var Zn = !W(Un) || p(function () {
    var t = {};
    return Un[Xn].call(t) !== t;
  });
  Un = Zn ? {} : $e(Un), x(Un[Xn]) || Yn(Un, Xn, function () {
    return this;
  });
  var tr = {
  ...
  qr && Gr || (qr = function qr(t) {
    ...
    Vr.now(to(t));
  } : Kr && !Ur ? (Ar = (Ir = new Kr()).port2, Ir.port1.onmessage = eo, Dr = Qt(Ar.postMessage, Ar)) : d.addEventListener && x(d.postMessage) && !d.importScripts && Mr && "file:" !== Mr.protocol && !p(no) ? (Dr = no, d.addEventListener("message", eo, !1)) : Dr = $r in Lt("script") ? function (t) {
  ...
  if (!_o) {
    var So = new fo(),
      Oo = function Oo() {
        var t, e;
        for (br && (t = mo.domain) && t.exit(); e = So.get();) try {
          e();
        } catch (t) {
          throw So.head && io(), t;
        }
    ...
    Ur || br || po || !go || !yo ? !lo && bo && bo.resolve ? ((uo = bo.resolve(void 0)).constructor = bo, so = Qt(uo.then, uo), io = function io() {
      so(Oo);
    }) : br ? io = function io() {
      mo.nextTick(Oo);
  ...
  Vo && (Xo = function Xo(t) {
    ...
    var n = Ko(this),
      r = ni(Jr(this, Xo));
    return n.parent = !0, r.ok = !x(t) || t, r.fail = x(e) && e, r.domain = br ? ei.domain : void 0, 0 == n.state ? n.reactions.add(r) : xo(function () {
      ci(r, n);
    }), r.promise;
  }), ko = function ko() {
    var t = new jo(),
    ...
    Promise: Xo
  }), or(Xo, zo, !1, !0), Co = Y(zo), R && Co && !Co[wr] && (Eo = Co, To = wr, Po = {
    configurable: !0,
    get: function get() {
      return this;
    }
        ...
        return cc.init(_o2(_o2({}, r), {
          ...
          Object.assign(uc, _o2(_o2({}, t), {
            captchaOptions: _o2(_o2({}, t.captchaOptions), {
              h5_check_version: (null === (r = t.captchaOptions) || void 0 === r ? void 0 : r.closeDecisionCheck) ? "0.0.0" : "1.0.19"
            })
          }));
