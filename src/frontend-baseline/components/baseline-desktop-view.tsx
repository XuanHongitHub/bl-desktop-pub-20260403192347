          ...
          {[
            {
              ...
              key: "frontendBaseline.desktop.navProfiles",
            },
      ...
      <main className="flex min-h-0 flex-1 flex-col">
        <header className="flex flex-wrap items-center gap-3 border-b border-border px-4 py-3">
          ...
          <Badge variant="secondary">
            {t("frontendBaseline.desktop.badgePhaseA")}
          </Badge>
        ...
        <section className="grid gap-3 p-4 md:grid-cols-2 xl:grid-cols-4">
          <Card>
            <CardHeader className="pb-2">
              <CardDescription>
                {t("frontendBaseline.metrics.totalProfiles")}
              </CardDescription>
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardDescription>
                {t("frontendBaseline.status.running")}
              </CardDescription>
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardDescription>
                {t("frontendBaseline.status.syncing")}
              </CardDescription>
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardDescription>
                {t("frontendBaseline.metrics.visibleRows")}
              </CardDescription>
