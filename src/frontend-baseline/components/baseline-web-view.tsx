      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 py-8">
        <header className="rounded-xl border border-border bg-card p-6">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Badge variant="outline">{t("frontendBaseline.web.badgeShadcn")}</Badge>
          </div>
        ...
        <section className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
          {[
            ...
            { icon: Rocket, title: t("frontendBaseline.web.cards.readyForScale") },
            { icon: ShieldCheck, title: t("frontendBaseline.web.cards.stateSafety") },
            { icon: Globe, title: t("frontendBaseline.web.cards.crossSurface") },
          ].map((item) => (
            <Card key={item.title}>
        ...
        <Card className="min-h-[420px]">
          <CardHeader>
            <CardTitle className="text-sm">{t("frontendBaseline.web.previewListTitle")}</CardTitle>
          </CardHeader>
