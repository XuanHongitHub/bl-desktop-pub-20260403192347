import type { BaselineProfile, BaselineProfileStatus } from "@/frontend-baseline/types/profile";

const WORKSPACES = ["team-a", "team-b", "team-c", "team-d"] as const;
const TAGS = ["warm", "cold", "vip", "locked", "auto", "manual", "import"] as const;
...
export function patchProfile(profile: BaselineProfile, at: number): BaselineProfile {
  return {
    ...profile,
