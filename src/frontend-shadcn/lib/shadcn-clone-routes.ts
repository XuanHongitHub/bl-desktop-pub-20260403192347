...
export const SHADCN_CLONE_ROUTE_ENTRIES: ShadcnCloneRouteEntry[] = urls.map((url, index) => {
...
const fallbackEntry =
  SHADCN_CLONE_ROUTE_ENTRIES.find((entry) => entry.pathname === "/examples/dashboard") ??
...
export function getCloneRouteHref(surface: CloneSurface, slug?: string[]): string {
...
export function getCloneRouteHrefForEntry(surface: CloneSurface, entry: ShadcnCloneRouteEntry): string {
