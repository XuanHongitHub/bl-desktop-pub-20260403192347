...
export function BugloginHomePage({
  surface = "web",
}: {
  surface?: HomeSurface;
}) {
  ...
  return (
    <div
      className={cn(
        ...
        surface === "desktop"
          ? "h-[calc(100vh-var(--window-titlebar-height,0px))] overflow-auto"
          : "min-h-screen",
      )}
    >
      <header className="border-b bg-background">
        <div className="mx-auto flex h-14 w-full max-w-[1280px] items-center gap-2 px-4 md:px-6">
          <a href="#" className="inline-flex h-8 items-center">
            <Logo
              variant="full"
              className="h-6 w-auto max-w-[160px] object-contain align-middle"
              alt="BugLogin"
            />
          </a>
        ...
        <div className="mb-4 flex flex-wrap items-center gap-3">
          <div className="inline-flex items-center rounded-md border p-0.5">
            ...
            <Button
              variant="ghost"
              size="sm"
              className="h-7 rounded-sm px-3 text-xs text-muted-foreground"
            >
              Code
            </Button>
          </div>
          ...
          >
            <div
              className={cn(
                ...
                surface === "desktop" &&
                  "h-[calc(100vh-var(--window-titlebar-height,0px)-13rem)] min-h-[520px]",
              )}
            >
