...
>(
  (
    ...
    const isLocalPosition = position === "local";
    ...
    if (isLocalPosition) {
      return (
        ...
        >
          <div
            className={cn(
              "h-full w-[--sidebar-width] overflow-hidden transition-[width] duration-200 ease-linear",
    ...
    return (
      <div
        ...
        className={cn(
          ...
          isLocalPosition && "relative h-full",
        )}
        data-state={state}
        data-collapsible={state === "collapsed" ? collapsible : ""}
        data-variant={variant}
